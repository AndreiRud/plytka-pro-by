const stages = [
  ...
  { num: "03", title: "Укладка геотекстиля", desc: "Геотекстиль 150–200 г/м² с нахлёстом 15–20 см. Без него срок службы покрытия сокращается в 2–3 раза." },
  { num: "04", title: "Щебёночное основание", desc: "Щебень 20–40 мм послойно по 10–15 см с уплотнением виброплитой. Для парковки — 25–30 см." },
  { num: "05", title: "Установка бордюров", desc: "Борт на бетонный раствор М150–М200. Выставляем по нитке строго по уровню — задаёт высоту покрытия." },
  { num: "06", title: "Выравнивающий слой ЦПС", desc: "Цементно-песчаная смесь 1:6 толщиной 3–5 см, протягиваем правилом. Влажность не более 5%." },
  { num: "07", title: "Укладка плитки", desc: "Осаживаем киянкой до уровня, зазор 2–3 мм. Подрезку выполняем болгаркой с алмазным диском." },
  { num: "08", title: "Заполнение швов", desc: "Кварцевый песок 0–2 мм, 2–3 прохода виброплитой с резиновой подошвой. Повторная просыпка через 2–3 недели." },
];
    ...
    <section id="stages" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12 font-body">
          8 этапов для долговечного покрытия — каждый контролируется
        </p>
