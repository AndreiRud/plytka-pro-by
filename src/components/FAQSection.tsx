...
const faqs = [
  {
    ...
    a: "Стоимость от 20 бел. руб./м² на готовое основание. Итоговая цена зависит от типа плитки, схемы раскладки, вида основания и необходимости бордюров и водоотвода. Для автомобильной площадки — от 22 р./м², сложный рисунок — от 23 р./м².",
  },
  {
