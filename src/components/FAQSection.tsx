...
const faqs = [
  ...
  {
    q: "Как обеспечивается качество укладки?",
    a: "Мы контролируем каждый этап работ: уплотнение основания, уклон для водоотвода, ширину швов. Все позиции фиксируются в договоре."
  },
  {
