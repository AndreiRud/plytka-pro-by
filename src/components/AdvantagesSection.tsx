...
const advantages = [
  {
    ...
    desc: "Оплата по факту выполнения этапа, зафиксированного в договоре.",
  },
  {
    icon: Shield,
    title: "Качество работ",
    desc: "Выполняем работы качественно — просадки, расхождение швов и разрушение покрытия исключены.",
  },
  {
    icon: Wrench,
    title: "Работа под ключ",
    desc: "От выемки грунта до установки дождеприемников, включая закупку материалов.",
  },
  {
    icon: PhoneCall,
    title: "Консультация мастера",
    desc: "Предварительный выезд для оценки основания, расчёт по фото.",
  },
  {
    icon: Clock,
    title: "Без скрытых доплат",
    desc: "Смета согласовывается до начала работ, все позиции в договоре.",
  },
  {
    icon: Percent,
    title: "Скидки от 100 м²",
    desc: "Чем больше площадь, тем ниже цена укладки за м².",
  },
];
